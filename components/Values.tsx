    ...
    <section className="section-padding relative overflow-hidden bg-white" id="values">
      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          <h2 className="text-xl sm:text-3xl lg:text-4xl font-bold text-secondary-900 mb-3 md:mb-4 font-outfit tracking-tight uppercase">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-16 md:mb-24">
          {values.map((value, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-white border border-secondary-100 rounded-2xl md:rounded-[2.5rem] p-6 md:p-10 text-center group hover:shadow-2xl hover:shadow-secondary-200/20 transition-all duration-500 relative overflow-hidden h-full shadow-xl shadow-secondary-200/5"
            >
              <div className="relative mb-6 md:mb-8 z-10">
                <div className="w-14 h-14 md:w-20 md:h-20 bg-secondary-900 rounded-2xl md:rounded-3xl flex items-center justify-center mx-auto group-hover:scale-110 group-hover:bg-primary-600 transition-all duration-500 shadow-xl shadow-secondary-900/10">
                  <value.icon className="w-8 h-8 md:w-10 md:h-10 text-white" />
                </div>
              </div>
              
              <h3 className="text-xs md:text-sm font-bold text-secondary-900 mb-2 md:mb-3 font-outfit uppercase tracking-widest">
                {value.title}
              </h3>
              
              <p className="text-sm sm:text-[13px] text-secondary-600 leading-relaxed font-inter">
                {value.description}
              </p>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-white border border-secondary-100 rounded-2xl md:rounded-[3rem] p-5 md:p-16 relative overflow-hidden shadow-2xl shadow-secondary-200/20"
        >
          ...
          <div className="grid lg:grid-cols-2 gap-10 md:gap-16 items-center">
            <div>
              ...
              <h3 className="text-lg md:text-2xl font-bold text-secondary-900 mb-4 md:mb-6 font-outfit tracking-tight uppercase">
                Management <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-blue-500 italic">Partner</span>
              </h3>
              <div className="space-y-4">
                <p className="text-xs md:text-sm text-secondary-600 leading-relaxed font-inter">
            ...
            <div className="bg-white border border-secondary-100 rounded-2xl md:rounded-[2.5rem] p-6 md:p-10 shadow-xl relative overflow-hidden group">
              <h4 className="text-xl md:text-2xl font-black text-secondary-900 mb-6 md:mb-8 font-outfit tracking-tight text-center uppercase">
                What We Deliver
              </h4>
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                {[
                  ...
                  <li key={index} className="flex items-center space-x-3 group">
                    <div className="w-8 h-8 md:w-10 md:h-10 bg-white border border-secondary-100 rounded-lg md:rounded-xl flex items-center justify-center group-hover:bg-primary-600 transition-colors duration-300 shadow-sm">
                      <Shield className="w-4 h-4 md:w-5 md:h-5 text-primary-600 group-hover:text-white" />
                    </div>
                    <span className="text-secondary-700 font-medium text-xs md:text-sm uppercase tracking-wider">{item}</span>
                  </li>
                ))}
              </ul>
            </div>
